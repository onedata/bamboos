...
There is a S3proxy server deployed to allow anonymous read only access to the bucket
which is accessible via our VPN. The pull_artifact.py will use it if ~/.aws/credentials
is not found.
